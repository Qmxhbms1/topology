...
\begin{solution}
  \begin{enumerate}
    \item Let $X$ be our topological space.
      ...
      Let us consider its complement $X \ G$.
      Clearly we have that $X \ G = X \ Int(Cl(G))$.
    ...
    \item Let $A$ and $B$ be regularly open sets.
      ...
      Thus we really want to show that $Cl(A \cap B) = Cl(A) \cap Cl(B)$ when $A, B$ are regularly open.
      Since $Cl(A \cap B)$ is the smallest closed set containing $A \cap B$, $A \cap B \subset Cl(A) \cap Cl(B)$ and $Cl(A) \cap Cl(B)$ is closed by Theorem 3.4, it follows that $Cl(A \cap B) \subset Cl(A) \cap Cl(B)$.
% Not finished, fourth may be completely wrong direction
  \end{enumerate}
\end{solution}
